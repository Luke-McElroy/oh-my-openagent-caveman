...
24 files. Implements `hashline_edit` tool — hash-anchored file editing where every line reference includes content hash (`LINE#ID`). Validates hashes before applying edits, rejecting stale references.
